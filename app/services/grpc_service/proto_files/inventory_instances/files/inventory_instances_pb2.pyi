...
class MO(_message.Message):
    __slots__ = ["active", "creation_date", "document_count", "geometry", "id", "label", "latitude", "longitude", "model", "modification_date", "name", "p_id", "point_a_id", "point_b_id", "pov", "status", "tmo_id", "version"]
